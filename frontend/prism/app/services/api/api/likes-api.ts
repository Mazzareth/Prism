...
export const LikesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async likesCreate(contentId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Likes>> {
         ...
         * @throws {RequiredError}
         */
        async likesDelete(contentId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const LikesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        likesCreate(contentId: string, options?: RawAxiosRequestConfig): AxiosPromise<Likes> {
         ...
         * @throws {RequiredError}
         */
        likesDelete(contentId: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
