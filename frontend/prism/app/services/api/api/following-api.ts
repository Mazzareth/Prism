...
// @ts-ignore
import type { Following } from '../models';
/**
...
export const FollowingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async followingCreate(artistUsername: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Following>> {
         ...
         * @throws {RequiredError}
         */
        async followingDelete(artistUsername: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const FollowingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        followingCreate(artistUsername: string, options?: RawAxiosRequestConfig): AxiosPromise<Following> {
         ...
         * @throws {RequiredError}
         */
        followingDelete(artistUsername: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
