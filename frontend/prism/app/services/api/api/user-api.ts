...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        usersMeUpdate: async (username: string, email?: string, password?: string, isArtist?: boolean, profilePicture?: string | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async usersMeUpdate(username: string, email?: string, password?: string, isArtist?: boolean, profilePicture?: string | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersMeUpdate(username, email, password, isArtist, profilePicture, options);
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        usersMeUpdate(username: string, email?: string, password?: string, isArtist?: boolean, profilePicture?: string | null, options?: RawAxiosRequestConfig): AxiosPromise<User> {
            return localVarFp.usersMeUpdate(username, email, password, isArtist, profilePicture, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the public profile of a specific user.
         * @summary Get user profile.
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public usersMeUpdate(username: string, email?: string, password?: string, isArtist?: boolean, profilePicture?: string | null, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).usersMeUpdate(username, email, password, isArtist, profilePicture, options).then((request) => request(this.axios, this.basePath));
    }
