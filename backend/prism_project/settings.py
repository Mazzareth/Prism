...
# Get the SECRET_KEY from the environment variable, or use a default for development.
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # CORS (Important!)
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': True, # Recommended, security best practice
